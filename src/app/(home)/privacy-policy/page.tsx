            ...
            <CardContent>
              <div className="space-y-3 text-muted-foreground">
                ...
                <p>
                  ...
                  Regulation (GDPR), and other applicable data protection laws. By using our services, you consent to
                  the
            ...
            <CardContent>
              <div className="space-y-3 text-muted-foreground">
                ...
                <div className="ml-4 space-y-1">
                  ...
                  <p>Email: <a href="mailto:info@plendesk.com"
                               className="text-primary hover:underline">info@plendesk.com</a></p>
                </div>
                <p>
                  For all privacy-related inquiries, data subject requests, or concerns about how we handle your
                  personal data,
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="ml-4">
                      We may disclose your information when required by Swiss law, court orders, or regulatory
                      authorities,
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3 text-muted-foreground">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li><strong>Account Data:</strong> Retained while your account is active and for 2 years after account
                    closure
                  </li>
                  <li><strong>Support Records:</strong> Kept for 5 years to maintain service quality and resolve
                    disputes
                  </li>
                  <li><strong>Payment Information:</strong> Retained for 7 years as required by Swiss financial
                    regulations
                  </li>
                  <li><strong>Marketing Data:</strong> Deleted immediately upon withdrawal of consent</li>
                  <li><strong>Analytics Data:</strong> Anonymized after 2 years and retained for statistical purposes
                  </li>
                </ul>
                <p>
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="ml-4">
                      Update or correct inaccurate personal information through your account settings or by contacting
                      us.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="ml-4">
                      Request deletion of your personal data, subject to legal retention requirements and legitimate
                      business needs.
                    </p>
                  </div>
                ...
                <p>
                  To exercise these rights, contact us at <a href="mailto:info@plendesk.com"
                                                             className="text-primary hover:underline">info@plendesk.com</a>.
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="ml-4">
                      Required for basic platform functionality, including authentication, security, and session
                      management.
            ...
            <CardContent>
              <div className="space-y-3 text-muted-foreground">
                ...
                <p>
                  ...
                  Swiss Federal Data Protection and Information Commissioner (FDPIC) or your local data protection
                  authority.
                </p>
              </div>
            </CardContent>
